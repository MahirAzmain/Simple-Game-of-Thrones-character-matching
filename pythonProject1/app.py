...
df = pd.read_pickle("/Users/mahirazmainhaque/Desktop/pythonProject1/data.pkl")
...
# Display the selected and recommended characters side by side
col1, col2 = st.columns(2)  # Change from beta_columns to columns
